...
public interface IMortgageView {
     ...
     *
     * @post getAnotherMortgage = [ true if the user wants to enter another mortgage, false otherwise ]
     */
     ...
     *
     * @post getAnotherMortgage = [ true if the user wants to enter another customer, false otherwise ]
     */
